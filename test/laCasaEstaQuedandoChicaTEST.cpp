...
TEST(laCasaEstaQuedandoChicaTEST, dividirPorCero) {

    eph_h th = {{22114, 2020,   3,  319611, 629088, 3,  1,  1,  1,  3,  1,  2}, // Aglomerado de > 500.000 personas
                {22866, 2020,   3,  317157, 627217, 2,  40, 0,  1,  2,  1,  2}, // Región con dos hogares target,
                {22867, 2020,   3,  317157, 627217, 2,  40, 0,  1,  2,  2,  2}, // Uno con HC y el otro no
                {20957, 2020,   3,  313965, 623297, 1,  41, 0,  1,  3,  1,  2},
                {22110, 2020,   3,  319611, 629088, 3,  42, 0,  2,  3,  1,  2}, // Departamento
                //              {22111, 2020,   3,  319611, 629088, 3,  43, 0,  1,  3,  1,  2}, Región sin hogares (?)
                {22112, 2020,   3,  319611, 629088, 3,  44, 0,  1,  3,  1,  2}};
    ...
    eph_i ti = {{20957, 2020,   1,  1,  3,  1,  88, 0,  0,  90000,  10},
                ...
                {22866, 2020,   3,  1,  3,  2,  28, 1,  3,  0,      6},
                {22866, 2020,   4,  1,  3,  2,  28, 1,  3,  0,      6},
                {22867, 2020,   1,  1,  3,  2,  28, 1,  3,  0,      6},
                {22867, 2020,   2,  1,  3,  2,  28, 1,  3,  0,      6},
                {22867, 2020,   3,  1,  3,  2,  28, 1,  3,  0,      6},
                {22110, 2020,   1,  0,  3,  1,  18, 0,  0,  20000,  10},
                {22110, 2020,   2,  0,  3,  1,  18, 0,  0,  20000,  10},
                {22110, 2020,   3,  0,  3,  1,  18, 0,  0,  20000,  10},
                {22110, 2020,   4,  0,  3,  1,  18, 0,  0,  20000,  10},
